...
INSERT INTO
    utilisateurs (email, mot_de_passe, nom, prenom)
VALUES
    (
        'vie-scolaire1@test.com',
        '$2y$12$TJy1uk4VqF5.I3LLtaELNObOGjjB/UE1FsZvYGEqQ1yZucDrtugYO',
        'Martin',
        'Sophie'
    ),
    (
        'vie-scolaire2@test.com',
        '$2y$12$TJy1uk4VqF5.I3LLtaELNObOGjjB/UE1FsZvYGEqQ1yZucDrtugYO',
        'Dubois',
        'Pierre'
    ),
...
VALUES
    ...
    ('Seconde A', 'Seconde'),
    ('BTS SIO1', 'BTS') ON DUPLICATE KEY
UPDATE nom = nom;

CREATE TABLE
    IF NOT EXISTS eleves (
        id INT PRIMARY KEY AUTO_INCREMENT,
        nom VARCHAR(100) NOT NULL,
        prenom VARCHAR(100) NOT NULL,
...
INSERT INTO
    eleves (nom, prenom, date_naissance, classe_id)
VALUES
    ...
    ('Simon', 'Léa', '2004-08-07', 4) ON DUPLICATE KEY
UPDATE nom = nom;

CREATE TABLE
    IF NOT EXISTS professeurs (
        id INT PRIMARY KEY AUTO_INCREMENT,
        nom VARCHAR(100) NOT NULL,
        prenom VARCHAR(100) NOT NULL,
...
INSERT INTO
    professeurs (nom, prenom, matiere)
VALUES
    ...
    ('Richard', 'Léa', 'Espagnol') ON DUPLICATE KEY
UPDATE nom = nom;

CREATE TABLE
    IF NOT EXISTS sanctions (
        id INT PRIMARY KEY AUTO_INCREMENT,
...
VALUES
    (
        '2025-01-15',
        'Bavardage répété et manque de respect en cours',
        'Avertissement',
        1,
        1
    ),
    (
        '2025-01-20',
        'Retard non justifié de plus de 15 minutes',
        'Retenue',
        2,
        2
    ),
    (
        '2025-01-22',
        'Absence de matériel scolaire à plusieurs reprises',
        'Avertissement',
        3,
        3
    ),
    ...
    (
        '2025-02-01',
        'Travail non rendu malgré les rappels',
        'Retenue',
        5,
        5
    ) ON DUPLICATE KEY
